                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <!--   <li class="nav-item"><a class="nav-link js-scroll-trigger" href="checkinnew.php">In</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">Overview</a></li>
        ...
        <header class="masthead">
            ...
            <div class="container d-flex h-100 align-items-center">
                ...
                <div class="mx-auto text-center">
                    ...
                    <h1 class="mx-auto my-0 text-uppercase">BLOCKCHAIN COC</h1>

                    <h2 class="text-white-50 mx-auto mt-2 mb-5">Chain of Custody portal using blockchain that manages evidences.</h2>

                    <a class="btn btn-primary js-scroll-trigger" href="#portfolio">Get Started</a>
 ...
 <section id="portfolio" class="portfolio">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-title">
      ...
      <h2>Checkin Overview</h2>

      <p>An overview of the evidences.</p>
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="col-lg-12 d-flex justify-content-center">
        ...
        <ul id="portfolio-flters">
          ...
          <li data-filter=".filter-app">Products That Are In Custody</li>
    ...
    <?php
      ...
      // output data of each row
        ...
        while($row = $result->fetch_assoc()) {
          ...
          echo"<a href='productOut.php?productToRemove=$productID' title='More Details'><i class='bx bx-link'></i></a>";
