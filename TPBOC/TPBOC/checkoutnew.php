         ...
         <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary js-scroll-trigger" href="#portfolio">CHECK-OUT</a>
                </div>
            </div>
        </header>
           <!-- ======= Portfolio Section ======= -->
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="150">
      <div class="col-lg-12 d-flex justify-content-center">
        <ul id="portfolio-flters">
          ...
          <li data-filter=".filter-app">Products That Have Been Checked In</li>
        ...
        <div class="row">
          ...
          <?php
            ...
            // output data of each row
                ...
                echo"</h2>";
                echo"<div class='portfolio-links' >";
                echo"<a href='productOut.php?productToRemove=$productID' title='More Details'>";
                echo"<button type='button' class='btn btn-outline-success'>Check Out</button>";
                echo"</a>";
                echo"</div>";
