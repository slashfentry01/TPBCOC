            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="checkoutNathan.php">Out</a></li>
 ...
 <section id="blog" class="blog">
      <div class="container">
        ...
        echo"</div>";
              ...
              $filter_word = $_GET['filter'];

              $query = mysqli_query($conn, "SELECT * FROM `products` WHERE product_category='$filter_word' AND product_state='out'") or die(mysqli_error());
              while($fetch = mysqli_fetch_array($query)){
...
<div class="sidebar">
  ...
  <div class="sidebar-item categories">
    <ul>
     ...
     <li><a href="checkinNathan.php?filter=weapons" name="filters" >Weapons</a> </li> 

     <li><a href="checkinNathan.php?filter=narcotics" name="filters" >Narcotics</a></li>

     <li><a href="checkinNathan.php?filter=hardware" name="filters" >Hardware</a></li>

     <li><a href="checkinNathan.php?filter=documents" name="filters" >Documents</a></li> 

     <li><a href="checkinNathan.php?filter=vehicles" name="filters" >Vehicles</a></li> 
