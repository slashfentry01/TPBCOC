      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries" name="defaultview">
           ...
           <?php
            $query = "SELECT * FROM products WHERE product_state='out' ORDER BY product_title DESC ";
            $result = mysqli_query($conn, $query);

            if(ISSET($_POST['searchb'])) {
                $keyword = $_POST['keyword'];
               echo "<h2>Results</h2>";
               $query = mysqli_query($conn, "SELECT * FROM `products` WHERE `product_title` LIKE '%$keyword%' AND product_state='out' ORDER BY `product_title`") or die(mysqli_error());
...
<div class="sidebar">
  ...
  <div class="sidebar-item categories">
    ...
    <li><a href="sortnameASCin.php" name="Sorts" >Name (Ascending)</a> </li> 

    <li><a href="sortnameDSCin.php" name="Sorts" >Name (Decending)</a></li>

    <li><a href="sortdateASCin.php" name="Sorts" >Date Added (Ascending)</a></li>

    <li><a href="sortdateDSCin.php" name="Sorts" >Date Added (Decending)</a></li> 
