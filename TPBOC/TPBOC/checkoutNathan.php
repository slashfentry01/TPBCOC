...
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="checkinNathan.php">In</a></li>
 ...
 <section id="blog" class="blog">
      <div class="container">
        ...
        echo"</h2>";
        echo"<div class='portfolio-links'>";
        echo"<a href='productOut.php?productToAdd=$productID' title='More Details'>";
        ...
        echo"</div>";
              ...
              $query = mysqli_query($conn, "SELECT * FROM `products` WHERE category='$filter_word' AND product_state='in'") or die(mysqli_error());
              while($fetch = mysqli_fetch_array($query)){
...
<div class="sidebar">
  ...
  <div class="sidebar-item search-form">
    <form action="checkoutNathan.php" method="POST" >
  ...
  <div class="sidebar-item categories">
    <ul>
     ...
     <li><a href="checkoutNathan.php?filter=weapon" name="filters" >Weapons</a> </li> 

     <li><a href="checkoutNathan.php?filter=narcotic" name="filters" >Narcotics</a></li>

     <li><a href="checkoutNathan.php?filter=hardware" name="filters" >Hardware</a></li>

     <li><a href="checkoutNathan.php?filter=document" name="filters" >Documents</a></li> 

     <li><a href="checkoutNathan.php?filter=vehicle" name="filters" >Vehicles</a></li> 

     <li><a href="checkoutNathan.php?filter=others" name="filters" >Others</a></li> 
