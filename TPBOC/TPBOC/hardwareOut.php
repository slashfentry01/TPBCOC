...
echo "<br>";
echo "<br>"; */
$query = "UPDATE products SET location='$svr3001ProductId' , product_state='$svr3001Status' , timestamp='$timestamp3001' WHERE product_title='$svr3001ProductModel' ";
...
$query = "UPDATE products SET location='$svr3002ProductId' , product_state='$svr3002Status' , timestamp='$timestamp3002' WHERE product_title='$svr3002ProductModel' ";
// mysqli_query($conn,$query);
if (mysqli_query($conn, $query)) {
    echo "Record updated successfully";
}else {
...
$query = "UPDATE products SET location='$svr3003ProductId' , product_state='$svr3003Status' , timestamp='$timestamp3003' WHERE product_title='$svr3003ProductModel' ";
// mysqli_query($conn,$query);
if (mysqli_query($conn, $query)) {
    echo "Record updated successfully";
}else {
...
$query = "UPDATE products SET location='$svr3004ProductId' , product_state='$svr3004Status' , timestamp='$timestamp3004' WHERE product_title='$svr3004ProductModel' ";
// mysqli_query($conn,$query);
if (mysqli_query($conn, $query)) {
    echo "Record updated successfully";
}else {
...
$query = "UPDATE products SET location='$svr3005ProductId' , product_state='$svr3005Status' , timestamp='$timestamp3005' WHERE product_title='$svr3005ProductModel' ";
// mysqli_query($conn,$query);
if (mysqli_query($conn, $query)) {
    echo "Record updated successfully";
}else {
...
$query = "UPDATE products SET location='$svr3006ProductId' , product_state='$svr3006Status' , timestamp='$timestamp3006' WHERE product_title='$svr3006ProductModel' ";
// mysqli_query($conn,$query);
if (mysqli_query($conn, $query)) {
    echo "Record updated successfully";
}else {
 ...
 <section id="blog" class="blog">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            $query = "SELECT * FROM products WHERE category='hardware' AND product_state='in'";
            $result = mysqli_query($conn, $query);
            ...
            // output data of each row
                ...
                echo"</h2>";
                echo"<div class='portfolio-links'>";
                echo"<a href='productIn.php?productToAdd=$productID' title='More Details'>";
                echo"<button type='button' class='btn btn-outline-success'>Check IN</button>";
                echo"</a>";
                echo"</div>";
...
<div class="sidebar">
  ...
  <div class="sidebar-item categories">
    <ul>
      <li><a href="weaponsIn.php">Weapons <span>(25)</span></a></li><!-- done-->
      <li><a href="narcoticsOut.php">Narcotics <span>(12)</span></a></li><!-- done -->
      <li><a href="hardwareOut.php">Hardware <span>(5)</span></a></li><!-- done -->
      <li><a href="documentsOut.php">Documents <span>(22)</span></a></li><!-- done -->
      <li><a href="vehiclesOut.php">Vehicles <span>(8)</span></a></li> <!-- done -->
      <li><a href="othersOut.php">Others <span>(14)</span></a></li> <!-- done -->
    </ul>
