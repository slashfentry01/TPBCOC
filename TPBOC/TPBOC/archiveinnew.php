            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="archiveoutnew.php">Archive Out</a></li>
         ...
         <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary js-scroll-trigger" href="#portfolio">ARCHIVE-IN</a>
                </div>
            </div>
        </header>
           <!-- ======= Portfolio Section ======= -->
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="150">
      <div class="col-lg-12 d-flex justify-content-center">
        <ul id="portfolio-flters">
          ...
          <li data-filter=".filter-app">ARCHIVE EVIDENCE HERE!</li>
 ...
 <section id="blog" class="blog">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            $query = "SELECT * FROM products WHERE product_state='out' OR product_state='archive out'";
            ...
            // output data of each row
                ...
                echo"</h2>";
                echo"<div class='portfolio-links'>";
                echo"<a href='archiveIn.php?productToAdd=$productID' title='More Details'>";
                echo"<button type='button' class='btn btn-outline-success'>ARCHIVE IN</button>";
                echo"</a>";
                echo"</div>";
