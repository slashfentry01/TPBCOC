      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries" name="defaultview">
           ...
           <?php
            $query = "SELECT * FROM products WHERE product_state='in' ORDER BY timestamp DESC ";
            $result = mysqli_query($conn, $query);

            if(ISSET($_POST['searchb'])) {
                $keyword = $_POST['keyword'];
               echo "<h2>Results</h2>";
               $query = mysqli_query($conn, "SELECT * FROM `products` WHERE `product_title` LIKE '%$keyword%' AND product_state='in' ORDER BY `timestamp`") or die(mysqli_error());
