...
/*echo $svr3001Index;svr3006ProductId
echo "<br>";
         ...
         <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary js-scroll-trigger" href="#portfolio">RETRIEVE EVIDENCE</a>
                </div>
            </div>
        </header>
           <!-- ======= Portfolio Section ======= -->
 ...
 <section id="blog" class="blog">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            $query = "SELECT * FROM products WHERE product_state='archive out'";
            $result = mysqli_query($conn, $query);
            ...
            // output data of each row
                ...
                echo"</h2>";
                echo"<div class='portfolio-links'>";
                echo"<a href='reuseIn.php?productToAdd=$productID' title='More Details'>";
