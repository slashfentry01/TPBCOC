 ...
 <section id="blog" class="blog">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            $query = "SELECT * FROM products WHERE category='narcotic' AND product_state='out'";
            $result = mysqli_query($conn, $query);
...
<div class="sidebar">
  ...
  <div class="sidebar-item categories">
    <ul>
      ...
      <li><a href="narcoticsIn.php">Narcotics <span>(12)</span></a></li><!-- done -->
      <li><a href="hardwareIn.php">Hardware <span>(5)</span></a></li><!-- done -->
      <li><a href="documentsIn.php">Documents <span>(22)</span></a></li><!-- done -->
      <li><a href="vehiclesIn.php">Vehicles <span>(8)</span></a></li> <!-- done -->
      <li><a href="othersIn.php">Others <span>(14)</span></a></li> <!-- done -->
    </ul>
